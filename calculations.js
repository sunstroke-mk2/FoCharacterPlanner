            ...
            if(TotalTraitsCount<3)
              {
                ...
                TotalTraitsCount+=1;
               // $('#t'+i).css("color","red");
                 $('#t'+i).toggleClass('itemHighlighted item')
              }
          }
        else
          {
            ...
            TotalTraitsCount-=1;
            //$('#t'+i).css("color","black");
            $('#t'+i).toggleClass('item itemHighlighted')
          }
        $('#traitscounter').text(TotalTraitsCount+"/"+MAXTRAITS);
        calculateStats();
      }
...
(
  function () 
  {
     ...
     if(TakenDrugsCount[i]==0)
       {
         $('#d'+i).toggleClass('itemHighlighted item')
          //$('#d'+i).css("color","red");
          TakenDrugsCount[i]=1;
       }
    else
      {
        $('#d'+i).toggleClass('item itemHighlighted')
       // $('#d'+i).css("color","black");
        TakenDrugsCount[i]=0;
      }
...
function calculateStats()
{
  ...
  let baseCC=lowCap((10+getTraitBonus('Finesse','CriticalChance')+getTraitBonus('Bonehead','CriticalChance')+getPerkBonus('MoreCriticals')),0);
  
  let lookdis =35+getTraitBonus('ShortSighted','LookDistance')+getDrugBonus('Psycho','LookDistance')+getPerkBonus('FarSight');
  $('#LookDistance').children('.somenumbers').text(lowCap(lookdis,10));
  ...
  let ccCC=(0+getTraitBonus('Bruiser','CriticalChanceCC')+getPerkBonus('MeleeCriticalChance'));
  $("#CriticalChanceCC").children('.somenumbers').text((lowCap(ccCC,0)+baseCC)+'%');
// $('Rad-X') 
  let ApR=(60+getTraitBonus('DrunkMaster',"ApRegenerationTime")+getDrugBonus('Cola','ApRegenerationTime')+getDrugBonus('Jet','ApRegenerationTime')+getPerkBonus('ActionBoy','ApRegenerationTime'));
  $("#ApRegenerationTime").children('.somenumbers').text(ApR);
  ...
  let poires=0+getTraitBonus('FastMetabolism','PoisonResistance')+getPerkBonus('SnakeEater');
  $('#PoisonResistance').children('.somenumbers').text(lowCap(poires,0)+'%');
  
  let radres=0+getTraitBonus('FastMetabolism','RadiationResistance')+getPerkBonus('RadRoach');
  $('#RadiationResistance').children('.somenumbers').text((getDrugBonus('Rad-X','RadiationResistance')+lowCap(radres,0))+'%');
 ...
 // $('#CriticalChance').children('.somenumbers').text(lowCap(cc,0)+'%'),   
  ...
  $('#CritDamageMultiplier').children('.somenumbers').text((100+getTraitBonus('Pacifist','CritDamageMultiplier'))+'%');
   ...
   let hpreg=(20+getTraitBonus('RadChild','HpRegenVal')+getPerkBonus('NaturalHealing'));
   $('#HpRegenVal').children('.somenumbers').text(lowCap(hpreg,0)),
   ...
   $('#CriticalResistance').children('.somenumbers').text((getTraitBonus('SmallFrame','CriticalResistance')+getDrugBonus('Buffout','CriticalResistance')+getPerkBonus('LuckyBastard'))+'%'),
    ...
    $('#CriticalChanceRC').children('.somenumbers').text(((getPerkBonus('Hunter'))+baseCC)+'%');
